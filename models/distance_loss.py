...
def chamfer_distance(pc1, pc2):
    ...
    pc1_expand_tile = functions.tile(functions.expand_dims(pc1,2),(1,1,M,1))
    pc2_expand_tile = functions.tile(functions.expand_dims(pc2,1),(1,N,1,1))
    ...
    dist1 = functions.min(pc_dist,axis=2)
    idx1 = functions.argmin(pc_dist, axis=2)
    dist2 = functions.min(pc_dist,axis=1)
